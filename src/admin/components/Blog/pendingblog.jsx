                ...
                <div className="col">
                  <ul className="nav nav-tabs nav-tabs-solid">
                    <li className="nav-item">
                      <a className="nav-link" href="/blog">Acitive Blog</a>
                    </li>
                    <li className="nav-item">
                      <a className="nav-link active" href="/pending-blog">Pending Blog</a>
                    </li>
                  </ul>
                </div>
                <div className="col-auto">
                  <a className="btn btn-primary btn-sm" href="/add-blog"><i className="fas fa-plus mr-1" /> Add Blog</a>
                </div>
              </div>
              {/* Blog */}
                ...
                <div className="col-md-6 col-xl-4 col-sm-12">
                  ...
                  <div className="blog grid-blog">
                      ...
                      <ul className="entry-meta meta-item">
                        <li>
                          <div className="post-author">
                            <a href="/profile"><img src={DoctorThumb01} alt="Post Author" /> <span>Dr. Ruby Perrin</span></a>
                          </div>
                        </li>
                    ...
                    <div className="row pt-3">
                      <div className="col"><a href="/edit-blog" className="text-success"><i className="far fa-edit" /> Edit</a></div>
                  ...
                  <div className="blog grid-blog">
                    ...
                    <div className="blog-content">
                      <ul className="entry-meta meta-item">
                        <li>
                          <div className="post-author">
                            <a href="/profile"><img src={DoctorThumb02} alt="Post Author" /> <span>Dr. Darren Elder</span></a>
                          </div>
                        </li>
                  ...
                  <div className="blog grid-blog">
                    ...
                    <div className="blog-content">
                      <ul className="entry-meta meta-item">
                        <li>
                          <div className="post-author">
                            <a href="/profile"><img src={DoctorThumb03} alt="Post Author" /> <span>Dr. Deborah Angel</span></a>
                          </div>
                        </li>
                        <li><i className="far fa-clock" /> 3 Dec 2019</li>
                      </ul>
                  ...
                  <div className="blog grid-blog">
                    ...
                    <div className="blog-content">
                      <ul className="entry-meta meta-item">
                        <li>
                          <div className="post-author">
                            <a href="/profile"><img src={DoctorThumb04} alt="Post Author" /> <span>Dr. Sofia Brient</span></a>
                          </div>
                        </li>
                  ...
                  <div className="blog grid-blog">
                    ...
                    <div className="blog-content">
                      <ul className="entry-meta meta-item">
                        <li>
                          <div className="post-author">
                            <a href="/profile"><img src={DoctorThumb05} alt="Post Author" /> <span>Dr. Marvin Campbell</span></a>
                          </div>
                        </li>
                  ...
                  <div className="blog grid-blog">
                    ...
                    <div className="blog-content">
                      <ul className="entry-meta meta-item">
                        <li>
                          <div className="post-author">
                            <a href="/profile"><img src={DoctorThumb06} alt="Post Author" /> <span>Dr. Katharine Berthold</span></a>
                          </div>
                        </li>
                  ...
                  <div className="blog grid-blog">
                    ...
                    <div className="blog-content">
                      <ul className="entry-meta meta-item">
                        <li>
                          <div className="post-author">
                            <a href="/profile"><img src={DoctorThumb07} alt="Post Author" /> <span>Dr. Linda Tobin</span></a>
                          </div>
                        </li>
                  ...
                  <div className="blog grid-blog">
                    ...
                    <div className="blog-content">
                      <ul className="entry-meta meta-item">
                        <li>
                          <div className="post-author">
                            <a href="/profile"><img src={DoctorThumb08} alt="Post Author" /> <span>Dr. Paul Richard </span></a>
                          </div>
                        </li>
                  ...
                  <div className="blog grid-blog">
                    ...
                    <div className="blog-content">
                      <ul className="entry-meta meta-item">
                        <li>
                          <div className="post-author">
                            <a href="/profile"><img src={DoctorThumb09} alt="Post Author" /> <span>Dr. John Gibbs</span></a>
                          </div>
                        </li>
                  ...
                  <div className="blog grid-blog">
                    ...
                    <div className="blog-content">
                      <ul className="entry-meta meta-item">
                        <li>
                          <div className="post-author">
                            <a href="/profile"><img src={DoctorThumb10} alt="Post Author" /> <span>Dr. Olga Barlow</span></a>
                          </div>
                        </li>
