      ...
      const columns = [
          {
            ...
            render: (text, record) => (            
                <h2 className="table-avatar">
                  <a href="/profile" className="avatar avatar-sm mr-2"><img alt="" src={record.image} /></a>
          ...
          },
          {
            ...
            render: (text, record) => (            
                <h2 className="table-avatar">
                  <a href="/profile" className="avatar avatar-sm mr-2"><img alt="" src={record.PatientImg} /></a>
                  <a href="/profile">{record.PatientName}</a>
                </h2>
              ), 
          },
          {
