...
import IMG03 from "../../assets/images/avatar-03.jpg"
import IMG04 from "../../assets/images/avatar-04.jpg"
  ...
  <div className="content container-fluid">
    ...
    <div className="comp-sec-wrapper">
      ...
      <section className="comp-section">
        ...
        <div className="card">
          ...
          <div className="card-body">
            {/* Simple demo*/}
            <button className="btn btn-primary" type="button" data-toggle="modal" data-original-title="test" data-target="#exampleModal">Simple</button>
            ...
            <button className="btn btn-primary" type="button" data-toggle="modal" data-target="#exampleModalLong">Scrolling long content</button>
            ...
            <button className="btn btn-primary" type="button" data-toggle="modal" data-target="#exampleModalCenter">Vertically centered</button>
            ...
            <button className="btn btn-primary" type="button" data-toggle="modal" data-target="#tooltipmodal" >Tooltips and popovers</button>
            ...
            <button className="btn btn-primary" type="button" data-toggle="modal" data-target="#grid-modal">Using the grid</button>
    ...
    <div className="card">
      ...
      <div className="card-body btn-showcase">
        <button className="btn btn-primary" type="button" data-toggle="modal" data-target="#exampleModalfat" data-whatever="@mdo">Open modal for @mdo</button>
        <button className="btn btn-primary" type="button" data-toggle="modal" data-target="#exampleModalmdo" data-whatever="@fat">Open modal for @fat</button>
        <button className="btn btn-primary" type="button" data-toggle="modal" data-target="#exampleModalgetbootstrap" data-whatever="@getbootstrap">Open modal for @getbootstrap</button>
    ...
    <div className="card">
      ...
      <div className="card-body">
        ...
        {/* Large modal*/}
        <button className="btn btn-primary" type="button" data-toggle="modal" data-target=".bd-example-modal-lg" >Large modal</button>
        ...
        {/* Small modal*/}
        <button className="btn btn-primary" type="button" data-toggle="modal" data-target=".bd-example-modal-sm">Small modal</button>
